...
<?php /* wp_nonce_field('update-options'); */?>
	...
	<tr valign="top">
		...
		<td><?php _e('Place up to '); ?><select name="AdsDisp" style="width:50px;font-weight:bold">
				...
				<?php } ?></select><?php _e(' Ads on a page. Select no more than <b>3 Ads</b> on a page for optimum visitor experience.'); ?><br/>

				<span class="description" style="font-style:italic"><?php _e('(For all practical purposes, 3 ad blocks on a page should suffice.)'); ?></span><br/>
	...
	<p style="margin-top:0px"><span class="description"><?php _e('Paste up to <b>'.$QData['Ads'].' Ads codes</b> on Post Body as assigned above, and up to <b>'.$QData['AdsWid'].' Ads codes</b> on Sidebar Widget. Ads codes provided must <b>not</b> be identical, repeated codes may result in Ads not being displayed correctly. Ads will never display more than once in a page.') ?></span></p>	
